// shamelessly copied from zjit/build.rd
// This build script is only used for `make yjit-check` for building
...
fn main() {
    ...
    if let Some(ruby_build_dir) = option_env!("RUBY_BUILD_DIR") {
        ...
        // When doing a combo build, there is a copy of YJIT symbols in libruby.a
